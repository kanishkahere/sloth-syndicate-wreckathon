...
const Signup = () => {
  return (
    <div className="min-h-screen relative flex items-center justify-center px-6 py-12">
      ...
      <div className="relative z-10 w-full max-w-[600px] bg-white/80 backdrop-blur rounded-3xl p-6 md:p-8 shadow-glow">
        ...
        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); }}>
          <div className="space-y-1">
            ...
            <input id="name" required className="w-full px-4 py-3 rounded-lg border border-border bg-white focus:ring-2 focus:ring-cyan-400 outline-none" />
          </div>
          <div className="space-y-1">
